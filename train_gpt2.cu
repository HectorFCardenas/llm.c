...
void gpt2_forward(GPT2 *model, const int* inputs, size_t B, size_t T) {
    ...
    layernorm_forward((model->recompute < 2) ? acts.ln1 : acts.lnf, acts.ln1_rstd, acts.encoded, params.ln1w, params.ln1b, B, T, C, main_stream);
    ...
    for (int l = 0; l < L; l++) {
        ...
        fused_residual_forward5(l_residual2, l_ln2, l_ln2_rstd, residual, scratch, l_ln2w, l_ln2b, B*T, C, main_stream);
        ...
        if(l+1 != L) {
            ...
            fused_residual_forward5(l_residual3, l_ln1, l_ln1_rstd, l_residual2, scratch, l_ln1w, l_ln1b,
                                    B * T, C, main_stream);
        } else {
            fused_residual_forward5(l_residual3, acts.lnf, acts.lnf_rstd, l_residual2, scratch,
...
void gpt2_backward_and_reduce(GPT2 *model, int* inputs, const int* targets, int grad_accum_steps, int micro_step) {
    ...
    layernorm_backward(dresidual, grads.lnfw, grads.lnfb, scratchF, model->acts.scratch_bt4c, residual, params.lnfw, acts.lnf_rstd, B, T, C, main_stream);
    ...
    for (int l = L-1; l >= 0; l--) {
        ...
        if(model->recompute >= 2) {
            ...
            layernorm_forward(l_ln2, l_ln2_rstd, l_residual2, l_ln2w, l_ln2b, B, T, C, main_stream);
        }
        matmul_backward(dl_btc, dl_fcw, dl_fcb, dl_bt4c, l_ln2, l_fcw, scratchF, B, T, C, 4 * C, main_stream);
        // layernorm backward does += to the dresidual, so it correctly accumulates grad from the MLP block above
        layernorm_backward(dresidual, dl_ln2w, dl_ln2b, scratchF, dl_btc, l_residual2, l_ln2w, l_ln2_rstd, B, T, C, main_stream);
        ...
        #endif
        if(model->recompute >= 2) {
            layernorm_forward(l_ln1, l_ln1_rstd, residual, l_ln1w, l_ln1b, B, T, C, main_stream);
        }
        ...
        layernorm_backward(dresidual, dl_ln1w, dl_ln1b, scratchF, dl_btc, residual, l_ln1w, l_ln1_rstd, B, T, C, main_stream);
